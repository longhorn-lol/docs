      ...
      className={`w-full flex flex-col gap-3 cursor-pointer py-3 px-4 rounded border
        ${
          ...
          `border-blue-200 bg-blue-100 hover:bg-blue-200/80 text-blue-900
           dark:border-blue-200/30 dark:bg-blue-900/30 dark:hover:bg-blue-800/30 dark:text-blue-100 dark:hover:text-blue-50
           transition-colors duration-200`
        }
        ${
          theme === "sky" &&
          `border-sky-200 bg-sky-100 hover:bg-sky-200/80 text-sky-900
           dark:border-sky-200/30 dark:bg-sky-900/30 dark:hover:bg-sky-800/30 dark:text-sky-100 dark:hover:text-sky-50
           transition-colors duration-200`
        }
        ${
          theme === "cyan" &&
          `border-cyan-200 bg-cyan-100 hover:bg-cyan-200/80 text-cyan-900
           dark:border-cyan-200/30 dark:bg-cyan-900/30 dark:hover:bg-cyan-800/30 dark:text-cyan-100 dark:hover:text-cyan-50
           transition-colors duration-200`
        }
        ${className}`}
